...
if %sel%==9 call system\createdir.bat && goto menu
if %sel%==10 call system\removedir.bat && goto menu
if %sel%==11 start main.bat && exit
if %sel%==12 exit
if %sel%==13 call system\restartmenu.bat
goto menu